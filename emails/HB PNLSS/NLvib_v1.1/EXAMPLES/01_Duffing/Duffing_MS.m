...
PHI_lin = PHI_lin(:,ind);
D_mod = (PHI_lin'*oscillator.D*PHI_lin)/2/om_lin;
...
figure; hold on;
plot(log10(energy_HB),(del_HB*2.*om_HB),'k-x');
xlabel('log10(energy)'); ylabel('D');